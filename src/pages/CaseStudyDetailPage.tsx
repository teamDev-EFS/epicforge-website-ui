...
const CaseStudyDetailPage: React.FC = () => {
  ...
  const caseStudy = {
    ...
    challenge:
      "TechRetail was struggling with low organic traffic and poor conversion rates. Their existing website wasn't optimized for modern search engines or AI platforms like ChatGPT.",
    solution:
      "We implemented our comprehensive AI SEO strategy combined with UX redesign and voice search optimization.",
    results: [
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {caseStudy.results.map((result, index) => (
            <div
              key={index}
              className="bg-white p-6 rounded-xl shadow-lg border-2 border-teal-100 text-center"
            >
        ...
        >
          ...
          <div className="space-y-4">
            {caseStudy.steps.map((step, index) => (
              <div
                key={index}
                className="flex items-start space-x-4 bg-white p-6 rounded-xl shadow-md border border-gray-200"
              >
