...
import { Search, ChevronDown, ChevronUp, HelpCircle, MessageCircle, Book, Video } from 'lucide-react';
      ...
      faqs: [
        {
          ...
          answer: "Simply book a free consultation call or request an AI audit through our website. Our team will analyze your needs and create a custom solution proposal within 24 hours."
        },
        {
          question: "What information do I need to provide for a quote?",
          answer: "We need basic information about your business, project goals, timeline, and budget range. Our AI chatbot can guide you through the process interactively."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "LLM SEO optimizes your content for Large Language Models like ChatGPT, Perplexity, and Google AI Overview. We use structured data, conversational Q&A formatting, and schema markup to ensure AI systems cite your brand as an authority."
        },
        {
          question: "How long does it take to see results from AI SEO?",
          answer: "Most clients see initial improvements in 2-3 months, with significant traffic growth (200-350%) within 6 months. Results vary based on industry competitiveness and current website state."
        },
        {
          question: "Do you optimize for voice search?",
          answer: "Yes! Our AI SEO includes voice search optimization for platforms like Alexa, Google Assistant, and Siri. We structure content to answer natural language queries effectively."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "We use modern technologies including React, Next.js, TypeScript, Node.js, Python, and cloud platforms like AWS and Supabase. Our tech stack is customized based on project requirements."
        },
        {
          question: "Can you integrate AI chatbots into existing websites?",
          answer: "Absolutely! Our AI chatbots with voice assistant capabilities can be integrated into any website platform including WordPress, Shopify, custom applications, and more."
        },
        {
          question: "What kind of automation can you build?",
          answer: "We build workflow automation, data processing pipelines, AI-powered decision systems, quotation generators, CRM integrations, email automation, and custom business logic automation."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "Pricing varies based on project scope. Website development starts at $5,000, AI SEO packages start at $2,000/month, and enterprise automation projects are quoted custom. Contact us for a detailed proposal."
        },
        {
          question: "Do you offer payment plans?",
          answer: "Yes, we offer flexible payment plans including milestone-based payments for projects and monthly subscriptions for ongoing services like AI SEO and maintenance."
        }
      ]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-gradient-to-br from-teal-600/20 to-cyan-600/20 backdrop-blur-sm p-6 rounded-xl border border-teal-500/20 hover:border-teal-500/50 transition-all cursor-pointer">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Chat with AI Assistant</h3>
          ...
          <div className="bg-gradient-to-br from-indigo-600/20 to-purple-600/20 backdrop-blur-sm p-6 rounded-xl border border-indigo-500/20 hover:border-indigo-500/50 transition-all cursor-pointer">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Browse Documentation</h3>
            <p className="text-gray-400 text-sm">Explore our comprehensive guides</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-pink-600/20 to-rose-600/20 backdrop-blur-sm p-6 rounded-xl border border-pink-500/20 hover:border-pink-500/50 transition-all cursor-pointer">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Watch Tutorials</h3>
            <p className="text-gray-400 text-sm">Learn from video walkthroughs</p>
          </div>
        </motion.div>
